#!/usr/bin/env bash
#SBATCH --job-name=F5-Open-Bible-Hiligaynon
...
accelerate launch --num_processes 2 --mixed_precision bf16 src/f5_tts/train/train.py --config-name F5TTS_v1_Base_Open_Bible_Hiligaynon.yaml
