#!/usr/bin/env bash
#SBATCH --job-name=VITS-Open-Bible-Nepali
...
##################################################################
DATA_SRC=/network/scratch/g/guzmand/Repositories/open-bible-models/F5-TTS/data/open-bible-nepali
DATA_DST=$SLURM_TMPDIR/data/open-bible-nepali
