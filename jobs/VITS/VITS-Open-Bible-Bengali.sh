#!/usr/bin/env bash
#SBATCH --job-name=VITS-Open-Bible-Bengali
...
##################################################################
DATA_SRC=/network/scratch/g/guzmand/Repositories/open-bible-models/F5-TTS/data/open-bible-bengali
DATA_DST=$SLURM_TMPDIR/data/open-bible-bengali
