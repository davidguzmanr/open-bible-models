#!/usr/bin/env bash
#SBATCH --job-name=VITS-Open-Bible-Vietnamese
...
##################################################################
DATA_SRC=/network/scratch/g/guzmand/Repositories/open-bible-models/F5-TTS/data/open-bible-vietnamese
DATA_DST=$SLURM_TMPDIR/data/open-bible-vietnamese
...
python -m trainer.distribute \
  ...
  --language vi \
  --output_path outputs/vietnamese \
