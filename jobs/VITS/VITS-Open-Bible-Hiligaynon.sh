#!/usr/bin/env bash
#SBATCH --job-name=VITS-Open-Bible-Hiligaynon
...
##################################################################
DATA_SRC=/network/scratch/g/guzmand/Repositories/open-bible-models/F5-TTS/data/open-bible-hiligaynon
DATA_DST=$SLURM_TMPDIR/data/open-bible-hiligaynon
...
python -m trainer.distribute \
  ...
  --language hil \
  --output_path outputs/hiligaynon \
