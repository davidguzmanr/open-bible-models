#!/usr/bin/env bash
#SBATCH --job-name=VITS-Open-Bible-Haitian-Creole
...
##################################################################
DATA_SRC=/network/scratch/g/guzmand/Repositories/open-bible-models/F5-TTS/data/open-bible-haitian-creole
DATA_DST=$SLURM_TMPDIR/data/open-bible-haitian-creole
...
python -m trainer.distribute \
  ...
  --language ht \
  --output_path outputs/haitian-creole \
