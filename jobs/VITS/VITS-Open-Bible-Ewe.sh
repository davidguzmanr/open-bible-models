#!/usr/bin/env bash
#SBATCH --job-name=VITS-Open-Bible-Ewe
...
##################################################################
DATA_SRC=/network/scratch/g/guzmand/Repositories/open-bible-models/F5-TTS/data/open-bible-ewe
DATA_DST=$SLURM_TMPDIR/data/open-bible-ewe
