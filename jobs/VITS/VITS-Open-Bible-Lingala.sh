#!/usr/bin/env bash
#SBATCH --job-name=VITS-Open-Bible-Lingala
...
##################################################################
DATA_SRC=/network/scratch/g/guzmand/Repositories/open-bible-models/F5-TTS/data/open-bible-lingala
DATA_DST=$SLURM_TMPDIR/data/open-bible-lingala
