#!/usr/bin/env bash
#SBATCH --job-name=VITS-Open-Bible-Gofa
...
##################################################################
DATA_SRC=/network/scratch/g/guzmand/Repositories/open-bible-models/F5-TTS/data/open-bible-gofa
DATA_DST=$SLURM_TMPDIR/data/open-bible-gofa
