#!/usr/bin/env bash
#SBATCH --job-name=VITS-Open-Bible-Punjabi
...
##################################################################
DATA_SRC=/network/scratch/g/guzmand/Repositories/open-bible-models/F5-TTS/data/open-bible-punjabi
DATA_DST=$SLURM_TMPDIR/data/open-bible-punjabi
